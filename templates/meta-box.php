...
if ($api_provider === 'openai') {
    ...
    $has_api_key = isset($settings['gemini_api_key']) && !empty($settings['gemini_api_key']);
    $provider_name = 'Gemini Flash';
    $provider_color = '#00a5e4'; // cor azul-ciano do Gemini
}
...
<div class="llms-txt-wrapper llms-txt-meta-box <?php echo $editor_class; ?>">
    ...
    <div style="background-color: #fff; padding: 15px; border-radius: 4px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
            <div style="flex: 1;">
                <label for="llms_txt_description"
                    style="display: block; font-weight: 500; margin-bottom: 5px; color: #333;">
            ...
            <div style="display: flex; align-items: center;">
                ...
                <input type="hidden" name="llms_txt_exclude_hidden"
                    value="0"><!-- Campo oculto para garantir que o valor seja enviado mesmo quando desmarcado -->
                ...
                <span class="help-icon" style="margin-left: 5px; position: relative; display: inline-block;">
                    <svg style="height: 16px; width: 16px; color: #777; cursor: help;"
                    ...
                    <div class="tooltip"
                        style="position: absolute; z-index: 10; width: 250px; background-color: #333; color: #fff; font-size: 12px; border-radius: 4px; padding: 5px 8px; pointer-events: none; left: -100px; opacity: 0; visibility: hidden;">
        ...
        <div style="margin-bottom: 10px;">
            <textarea id="llms_txt_description" name="llms_txt_description" rows="3" maxlength="350"
                style="width: 100%; padding: 8px 10px; color: #333; border: 1px solid #ddd; border-radius: 4px; resize: vertical; box-sizing: border-box;"><?php echo esc_textarea($description); ?></textarea>
        ...
        <div id="llms_txt_feedback" style="margin-top: 15px; display: none;">
            <div id="llms_txt_loading" style="display: none;">
                <div style="display: flex; align-items: center;">
                    ...
                    <span
                        style="font-size: 13px; color: #3582c4;"><?php _e('Gerando descrição...', 'llms-txt-generator'); ?></span>
                </div>
            </div>

            <div id="llms_txt_success" style="display: none;">
                <div style="display: flex; align-items: center;">
                    <svg style="margin-right: 8px; height: 16px; width: 16px; color: #00a32a;"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd"
                    ...
                    <span
                        style="font-size: 13px; color: #00a32a;"><?php _e('Descrição gerada com sucesso!', 'llms-txt-generator'); ?></span>
                </div>
            </div>

            <div id="llms_txt_error" style="display: none;">
                <div style="display: flex; align-items: center;">
                    <svg style="margin-right: 8px; height: 16px; width: 16px; color: #d63638;"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd"
